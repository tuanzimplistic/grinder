...
#undef MODULE_DEF_MP_QSTR_ESP
#define MODULE_DEF_MP_QSTR_ESP { MP_ROM_QSTR(MP_QSTR_esp), MP_ROM_PTR(&esp_module) },

extern const struct _mp_obj_module_t esp32_module;
#undef MODULE_DEF_MP_QSTR_ESP32
#define MODULE_DEF_MP_QSTR_ESP32 { MP_ROM_QSTR(MP_QSTR_esp32), MP_ROM_PTR(&esp32_module) },
...
extern const struct _mp_obj_module_t mp_module_ubluetooth;
#undef MODULE_DEF_MP_QSTR_UBLUETOOTH
#define MODULE_DEF_MP_QSTR_UBLUETOOTH { MP_ROM_QSTR(MP_QSTR_ubluetooth), MP_ROM_PTR(&mp_module_ubluetooth) },
...
#define MODULE_DEF_MP_QSTR_UTIME { MP_ROM_QSTR(MP_QSTR_utime), MP_ROM_PTR(&utime_module) },
...
#define MICROPY_REGISTERED_MODULES \
    ...
    MODULE_DEF_MP_QSTR_ESP \
    MODULE_DEF_MP_QSTR_ESP32 \
